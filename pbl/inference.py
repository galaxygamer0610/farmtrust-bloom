...
async def full_assessment(inp: dict) -> dict:
    ...
    output = {
        ...
        "eligibility_score": credit_results.get("eligibility_score", 0.5),
        "eligible_amount": credit_results.get("eligible_amount", 0.0),
        "requested_amount": credit_results.get("requested_amount", 0.0),
